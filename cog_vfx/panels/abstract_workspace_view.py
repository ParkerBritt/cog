...
import os
# pyside
from PySide6.QtWidgets import QWidget, QVBoxLayout, QLabel, QHBoxLayout, QButtonGroup, QPushButton, QTreeWidget, QTreeWidgetItem, QMenu
from PySide6.QtGui import QIcon
from PySide6.QtCore import QSize, Qt
# project modules
from ..utils import get_fonts, get_list_widget_data, get_style_sheet, get_pkg_asset_path, open_file, filter_env_vars
...
""")
        ...
        self.files_page_label.setStyleSheet("QLabel { background-color: rgba(0,0,0,0); }")
    ...
    def contextMenuEvent(self, event):
        ...
        if(item_data["is_dir"] == True):
            ...
            if(file_type in [".mb", ".ma", ".hipnc"]):
                ...
                cmenu.addAction("Open", lambda: open_file(item_data["file_path"], env_vars))
